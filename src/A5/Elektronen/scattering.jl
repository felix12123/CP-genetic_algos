...
function moe_energy_change(θ, E) # TODO
	...
	# p = sqrt(E^2 - m_e^2)
	# 2m_e * (E + m_e) * p * cos(θ) / (())
	return -E/50 * sin(θ)^2 * prefactor_moe_energy_change
end
